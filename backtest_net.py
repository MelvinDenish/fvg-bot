        ...
        for i in range(3, n):
            ...
            if self._count_open() < MAX_OPEN:
                ...
                for item in active:
                    ...
                    # R:R gate using NET R:R (after fees).
                    # Unlike backtest.py which gates on GROSS R:R, this file
                    # computes qty + fees FIRST, then verifies that the NET
                    ...
                    if self.tp_mode in ("fixed", "structure"):
                        ...
                        exit_fee_est  = qty * tp * self.fee_rate  # TP exit
                        sl_fee_est    = qty * sl * self.fee_rate   # SL exit
                        ...
                        if net_loss <= 0:
                            net_loss = 0.001  # prevent division by zero
